...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            //removeIcon: '<i class="close fileinput-remove"></i>',
            //removeIcon:'<span style="font-size: small;color: #dd1144">remove</span>'
            removeIcon:'',
        ...
        tActions = '' +
            ...
            '</div>' +
            '',
        tActionDelete = '<button id="removeBut" type="button" class="kv-file-remove {removeClass}" ' +
    'title="{removeTitle}"{dataUrl}{dataKey} style="height: 30px;width: 30px;border: 1px solid gray;padding: 0px;margin: 0px"></button>',
        tActionUpload = '<button id="uploadBut" type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
            '</button>\n',
