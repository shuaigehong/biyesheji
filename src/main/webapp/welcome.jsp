    ...
    <div class="wrap" id="wrap">
        ...
        <main>
            <ul class="ul items">
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_wedding_blessing.jpg" alt="»éÀñµÄ×£¸£|wedding blessing">
                        <figcaption>
                            <h2>
                                »éÀñµÄ×£¸£
                                <br>
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_taste.jpg" alt="ÃÀÊ³ÒÕÊõ¼Ò|taste">
                        <figcaption>
                            <h2>
                                ÃÀÊ³ÒÕÊõ¼Ò
                                <br>
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_dreamer.jpg" alt="ÃÎÏë¼Ò|dreamer">
                        <figcaption>
                            <h2>
                                ÃÎÏë¼Ò
                                <br>
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_maple_leaf.jpg" alt="·ãÒ¶½Ö|maple leaf">
                        <figcaption>
                            <h2>
                                ·ãÒ¶½Ö
                                <br>
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_My_Own_Secret.jpg" alt="ÃØÃÜ|My Own Secret">
                        <figcaption>
                            <h2>
                                ÃØÃÜ
                                <br>
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_wonder_world.jpg" alt="ÆæÊÀ½ç|wonder world">
                        <figcaption>
                            <h2>
                                ÆæÊÀ½ç
                                <br>
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_misical_diary.jpg" alt="ÒôÀÖÈÕ¼Ç|misical diary">
                        <figcaption>
                            <h2>
                                ÒôÀÖÈÕ¼Ç
                                <br>
                ...
                <li>
                    <figure class="effect-jazz">
                        <img src="img/welcomePage/modelImg/480_guess.jpg" alt="²ÂÏë|guess">
                        <figcaption>
                            <h2>
                                ²ÂÏë
                                <br>
